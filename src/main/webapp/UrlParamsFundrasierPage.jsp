...
<body>
	...
	<div class="container" id="main_.container">
		...
		<div class="right_container">
			...
			<p>
				raised of <strong> <span>&#8377</span>20000
				</strong> goal
			</p>
	...
	<form class="deposit_form" id="contribute_form"
		...
		<div class="step1">
			...
			<input type="number" id="deposit_amount" name="amount"
		...
		<div class="step3">
			...
			<input type="email" placeholder="ex.name@okhdfcbank" id="upiid">
			<span id="send_request">Send</span>
		</div>
