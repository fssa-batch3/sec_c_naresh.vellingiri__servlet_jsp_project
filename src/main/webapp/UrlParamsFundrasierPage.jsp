...
.contain_players_certificate_image, .contain_players_achievements_image,.videos_containing_div{
    display: flex;
    flex-wrap: wrap;
...
.contain_players_certificate_image img,.contain_players_achievements_image img{
    width: 700px;
...
<body>
	...
	System.out.print("hiii"+isArrived);
	%>
	...
	<div class="container" id="main_.container">
		...
		<div class="left_container">
			...
			<div class="about_content" id="about_content">
				...
				<p id="aboutpara">"Tried the best I could, says Virat Kohli</p>
			</div>
			<div class="certificates">
				...
				<img src="<%=fundraiser.getCertificate().get(i).getCerUrl()%>" alt="Kids Images"
				id="kidsimg">
				<%} %>
				</div>
...
<%List<Video> videos=fundraiser.getVideo(); %>
	...
	<iframe src="<%=fundraiser.getVideo().get(i).getVideoUrl()%>"></iframe>
		...
		<div class="right_container">
			...
			<h3 id="amt">
				<b style="color: black;"><span>&#8377</span>8</b>
			</h3>
			<p>
				raised of <strong> <span>&#8377</span>20,000</strong> goal
			</p>
			<div class="supporterbar">
				<div class="progress"
					style="background-color: rgba(1, 191, 189, 0.3);">
					<div class="progress-bar"
						style="width: 0.04%; background-color: rgb(1, 191, 189);">
						<span class="sr-only">70% Complete</span>
					</div>
				</div>
				<div class="suporters">
					<p id="suporters1">4 Supporters</p>
					<p>106 days left</p>
				</div>
			</div>
	...
	<form class="deposit_form" id="contribute_form">
		...
		<div class="step3">
			<p>
				<span>3</span>Enter your Upi ID
			</p>
			<input type="email" placeholder="ex.name@okhdfcbank" required
				id="upiid"> <span id="send_request">Send</span>
		</div>
		...
		<div class="step4">
			<p>
				<span>4</span>Accept the payment request sent to the Upi Id
			</p>
		</div>
		<div class="buttons">
