...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/assets/css/Profile/profile_all_style.css">
    <link rel="stylesheet" href="<%=request.getContextPath()%>/assets/css/FundraiserPage/form_creation_fundraiser.css">
    <link rel="stylesheet"
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="side-content">
            <div class="side-menu">
                <ul>
                    <li><a href="../profile/profile_detail.html"> <span class="las la-home"></span> <small>PROFILE</small></a></li>
                    <li><a href="#" class="active"> <span class="las la-user-alt"></span> <small>RAISE FUND</small></a></li>
                    <li><a href="#"> <span class="las la-envelope"></span> <small>DONATIONS</small></a></li>
                    <li><a href="../profile/your_fundraiser_page.html"> <span class="las la-clipboard-list"></span> <small>FUNDRAISERS</small></a></li>
    ...
    <!-- Form Creation -->
    <div form_creation_fundraiser class="container" id="form_creation_fundraiser">
        <form method="post" id="raise_fund">
            <h3 class="text-center">Raise your funds for future players</h3>
            <!-- Fundraising Details -->
            <div class="form-group">
                <label for="minimum_amount">How much do you want to raise fund?</label>
                <input type="text" class="form-control" id="minimum_amount" name="minimum_amount"
			       placeholder="Minimum Rs.2000" title="You can raise minimum Rs.2000" tooltip="minimum"
			       required
			       oninvalid="this.setCustomValidity('Please enter a valid amount (minimum Rs.2000).')"
			       oninput="this.setCustomValidity('')">

                <small class="form-text text-muted">You have to raise minimum Rs.2000.</small>
            </div>
            <div class="form-group center">
                ...
                <small class="form-text text-muted">Tell about who needs this fund.</small>
            </div>
            <div class="input-group">
                <div class="input-group-append">
            ...
            <small class="form-text text-muted">Enter your Educational qualification</small>
            <div class="form-group">
                <label for="sports_type">Sports Type</label>
                <input type="text" class="form-control" id="sports_type" name="sports_type"
                       placeholder="Sports Type..." required>
                <small class="form-text text-muted">Enter your sports type</small>
            </div>
            <!-- Player Details -->
			       <div class="form-group">
			    <label for="player_image_url">Player Image URL</label>
			    <input type="url" class="form-control" id="player_image_url" name="player_image_url"
			           required
			           oninvalid="this.setCustomValidity('Please enter a valid Player Image URL.')"
			           oninput="this.setCustomValidity('')">
			    <small class="form-text text-muted">Enter player image URL</small>
			</div>
			<div class="form-group">
			    <label for="player_title">Player Title</label>
			    <input type="text" class="form-control" id="player_title" name="player_title"
			           required
			...
			<div class="form-group">
			    <label for="days_left">Minimum Days to Get the Amount</label>
			    <input type="date" class="form-control" id="days_left" name="days_left"
			           required
			           oninvalid="this.setCustomValidity('Please enter a valid date for Minimum Days.')"
			           oninput="this.setCustomValidity('')">
			    <small class="form-text text-muted">Minimum days to get the amount you need.</small>
			</div>
			<div class="form-group">
			    <label for="Add_bio">Description</label>
			    <input type="text" class="form-control" id="Add_bio" name="add_description"
			           required
            ...
            <p class="btn btn-primary text-center" id="Add_certificates">+ Certificates</p>
            ...
            <button class="add_fundraiser_btn" id="next_button" type="submit" value="submit">Submit</button>
        </form>
    </div>

    <!-- Certificate Details Popup -->
    <div form_creation_fundraiser class="container certificate_whole_div" id="certificate_whole_div">
        <div class="certificate_heading_div">
            <h3 class="text-center">Certificate Details</h3>
            <span id="cross_mark"> &#10060;</span>
        </div>
        <div class="form-group">
            <label for="certificate_image_url">Certificate Image URL</label>
            <input type="url" class="form-control" id="certificate_image_url" name="certificate_img_url"
                   title="Please enter valid certificate image URL" required 
                     oninvalid="this.setCustomValidity('Please enter a proper certificate image url')"
			           oninput="this.setCustomValidity('')">
            <small class="form-text text-muted">Certificate image URL</small>
        </div>
        <div class="form-group">
            <label for="certificate_number">Certificate Number</label>
            <input type="text" class="form-control" id="certificate_number" name="certificate_number"
                   title="Please enter valid certificate number" maxlength="16" minlength="8" required
                     oninvalid="this.setCustomValidity('Please enter a unique certificate number.')"
			           oninput="this.setCustomValidity('')">
            <small class="form-text text-muted">Certificate number</small>
        </div>
        <input type="submit" class="add_fundraiser_btn" id="add_button" value="Add">
    </div>
    
    <!-- Video Details Popup -->
    <div form_creation_fundraiser class="container video_whole_div" id="video_whole_div">
        <div class="certificate_heading_div">
            <h3 class="text-center">Video Details</h3>
            <span id="cross_mark"> &#10060;</span>
        </div>
        <div class="form-group">
            <label for="videos_url">Video URL</label>
            <input type="url" class="form-control" id="videos_url" name="video_url"
                   title="Please enter valid video URL" required>
            <small class="form-text text-muted">Video URL's</small>
        </div>
        <input type="submit" class="add_fundraiser_btn" id="add_video_button" value="Add">
    </div>
